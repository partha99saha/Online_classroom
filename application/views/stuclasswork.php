...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="<?php echo base_url().'index.php/Project/stustream'?>" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="STREAM"><i class="fa fa-globe"></i>Stream</a>
